...
### 2. タスクがアサインされた際に、アサインされたユーザーが気づきにくい
### 3. タスクをまとめて追加することができない
### 4. 現場社員以外の社員にもタスク追加・タスク完了などの通知が届くようにする

## 追加予定機能

### フェーズ1
<b>現在のサービスを改善し、機能追加していく</b>
### フェーズ2
<b>現在の主要な機能を残しつつ、社内向け開発から他社企業向けの開発へとサービスを展開していく</b>
