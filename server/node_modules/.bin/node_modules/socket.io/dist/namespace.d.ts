import { Socket } from "@socket.io/node_modules/socket.io/dist/socket";
import type { Server } from "socket.io";
import { EventParams, EventNames, EventsMap, StrictEventEmitter, DefaultEventsMap, DecorateAcknowledgementsWithTimeoutAndMultipleResponses, AllButLast, Last, FirstArg, SecondArg } from "socket.io/dist/typed-events";
import type { Client } from ".bin/node_modules/socket.io/dist/client";
import type { Adapter, Room, SocketId } from "socket.io-adapter";
import { BroadcastOperator } from "@socket.io/node_modules/socket.io/dist/broadcast-operator";
...
export declare class Namespace<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ServerSideEvents, EmitEvents, NamespaceReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
     ...
     * }
     */
    fetchSockets(): Promise<import("@socket.io/node_modules/socket.io/dist/broadcast-operator").RemoteSocket<EmitEvents, SocketData>[]>;
    /**
